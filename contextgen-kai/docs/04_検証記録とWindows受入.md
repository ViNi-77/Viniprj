...
対象: contextgen 改 0.2.0 / 文書版0.2 / 2026-09-23
...
実Git cloneからBATを実行し、初回環境作成・変更なし再起動でpip呼出しなし・同梱OCR抽出・実行中更新拒否を検証する工程を追加。配布EXEからマニュアル・画像・3文書をHTTPで取得する工程も追加した。結果は本版のCI実行後に記録する。
