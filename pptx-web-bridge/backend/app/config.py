...
#   （logs はここに作られる。利用者が見つけやすく、削除も容易）
...
_DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "paths": {"logs_dir": "logs"},
    "limits": {"max_upload_mb": 50, "max_slides": 300},
    "html_import": {"max_columns": 3},
    "copilot": {"chat_url": "https://m365.cloud.microsoft/chat", "max_prompt_chars": 12000},
    "logging": {"level": "INFO", "file_name": "app.log", "max_bytes": 2_000_000, "backup_count": 3},
}
